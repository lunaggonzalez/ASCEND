...
var com = 40
var fuel_cost = 0
var thing = 0 #in-between state that helps with calculation of exponent
var methane = 0
var oxygen = 0
...
var temp
var enginePower
var fuelNeedleRotation = 91.9
signal fuel_value(deg: float)

func _integrate_forces(state: PhysicsDirectBodyState2D) -> void:
	fuelNeedleRotation = ((methane - fuel_cost)/1000)*(190/100) - 98.1
	if fuelNeedleRotation < 0:
		fuelNeedleRotation = 0
	elif fuelNeedleRotation > 91.9:
		fuelNeedleRotation = 91.9
	fuel_value.emit("fuelNeedleRotation", fuelNeedleRotation)
	...
	if launchstart:
		...
		print(global_position, " Y Velocity:", state.get_velocity_at_local_position(global_position).x , " Rotation: ", rotation_degrees, " Fuel: ", methane - fuel_cost, " Exponent: ", expo)
